...
<button type="button" onclick="location.href='./trip-frame.php?u_id=<?php echo $u_id; ?>'"  class="box-line2 r-float"><a class=" clear-text"><p class="other-title bold">新しい旅行記を作成</p></a></button>
					...
					<div class="clearFix">
						...
						<button type="button" onclick="location.href='./check-in.php?p_id=<?php echo $post['P_ID']; ?>'"  class="check-in l-float other-text shadow"><a class="clear-text">チェックイン</a></div>
					</div>
					<?php endforeach;?>					
