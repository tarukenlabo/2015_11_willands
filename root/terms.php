...
-->
	<article class="hadairo">
		<div class="form_box">
			<h1 class="align-c">利用規約</h1>
			
			<p>※当サイトは、ウィランズパソコンスクールの求職者支援訓練にて制作しています。<br>
				下記サイトを参照し、利用規約を記載しています。</p>
			<a href="http://kiyaku.jp/hinagata/sns.html">参照：Webサイトの利用規約</a>


			<div class="wrapHINAGATA">
			<h1>利用規約</h1>

			<p>この利用規約（以下，「本規約」といいます。）は，たるナビグループ（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
