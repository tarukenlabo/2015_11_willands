			...
			<div class="box shadow">
				...
				<form method="post" action="member_comp.php">
					<input type="hidden" name="mode" value="regist_confirm">
							...
							<p class="other-text"><input type="button" value="必 須" class="d-button pink text-white bold" disabled>メールアドレス</p>
							<?php if (isset($email)): print $email; else: ?><input type="text" size="30" name="input_mail"  class="box-line1"><?php endif; ?></p>

							<p class="other-text"><input type="button" value="必 須" class="d-button pink text-white bold" disabled>パスワード</p>
							...
							<p class="other-text"><input type="button" value="必 須" class="d-button pink text-white bold" disabled>パスワード（確認）</p>
